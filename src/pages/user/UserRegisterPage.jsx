    ...
    return (
        <div>
            <main className="flex items-center justify-center h-screen ">
                <form className="flex items-center flex-col p-8 border border-gray-200 rounded-xl" onSubmit={handleSubmit}>
                    <h1 className="font-bold text-lg mb-12">Daftar Sebagai Pengguna Baru</h1>
                    ...
                    <Button isLoading={register.isLoading} className="w-full" variant={"primary"}>Daftar</Button>

                    <div className="mt-4">
                        <p className="text-sm text-gray-500">Sudah punya akun? <NavLink className="text-blue-500 font-bold" to="/login">Masuk</NavLink></p>
                    </div>
                </form>
            </main>
        </div>
