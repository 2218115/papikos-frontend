  ...
  return (
    <div className={`w-full mb-4 flex flex-col ${className}`}>
      ...
      <div className="relative w-full" ref={parentRef}>
        ...
        {isOpen && (
          <ul
            className={`absolute z-10 mt-2 bg-white border border-gray-100 rounded-md shadow-lg max-h-60 overflow-auto transition-transform duration-200 ease-in-out ${
